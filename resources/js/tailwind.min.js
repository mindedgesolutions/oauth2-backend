...
(() => {
        ...
        for (let i = r + 1; i < t.length; i++)
            if (((o = t.charCodeAt(i)), 92 === o)) i += 1;
                ...
                if (o === e || (13 === o && t.charCodeAt(i + 1) === e))
                    throw new Error(
                        `Unterminated string: ${
                            t.slice(r, i) + String.fromCharCode(n)
                        }`
                    );
            }
        return r;
        ...
        function p(e, u, h = {}, m = 0) {
            if ("declaration" === e.kind) {
                ...
                if ("animation" === e.property)
                    for (let t of V(e.value)) s.add(t);
    ...
    var oe = {
        color: function (e) {
            return (
                35 === e.charCodeAt(0) || ne.test(e) || re.has(e.toLowerCase())
            );
        },
        length: ve,
        percentage: he,
            ...
            (function (e) {
                ...
                for (let e of t)
                    for (let t of e.items)
                        i.push([t.name, { modifiers: t.modifiers }]);
                return i;
            })(r)
        );
    }
    ...
    function et(e) {
        let t = (function (e) {
                ...
                function d({ negative: t }) {
                    return (r) => {
                        ...
                        if ("arbitrary" === r.value.kind) {
                            n = r.value.value;
                            let e =
                                r.value.dataType ?? ie(n, ["angle", "vector"]);
                            if ("vector" === e)
                ...
                let p = () =>
                    z([Ve("--tw-scroll-snap-strictness", "proximity", "*")]);
                        ...
                        if ("arbitrary" === t.value.kind) {
                            ...
                            switch (
                                ...
                                case "url":
                                    return t.modifier
                                        ? void 0
                                        : [x("background-image", r)];
                                default:
                                    return (
                                        (r = Fe(r, t.modifier, e)),
                                        null === r
                                            ? void 0
                                            : [x("background-color", r)]
                                    );
                            }
                        }
                        {
            ...
            r = (function (e) {
                ...
                r("first", ["&:first-child"]),
                    ...
                    t.functional("aria", (e, t) => {
                        ...
                        "arbitrary" === t.value.kind
                            ? (e.nodes = [
                                  k(`&[aria-${Xe(t.value.value)}]`, e.nodes),
                              ])
                            : (e.nodes = [
                                  k(`&[aria-${t.value.value}="true"]`, e.nodes),
                              ]);
                    }),
                    t.suggest("aria", () => [
                        "busy",
                    ...
                    t.functional("nth-last", (e, t) => {
                        if (
                            ...
                            return null;
                        e.nodes = [
                            k(`&:nth-last-child(${t.value.value})`, e.nodes),
                        ];
                    }),
                    t.functional("nth-of-type", (e, t) => {
                        if (
                            ...
                            return null;
                        e.nodes = [
                            k(`&:nth-of-type(${t.value.value})`, e.nodes),
                        ];
                    }),
                    t.functional("nth-last-of-type", (e, t) => {
                        if (
                            ...
                            return null;
                        e.nodes = [
                            k(`&:nth-last-of-type(${t.value.value})`, e.nodes),
                        ];
                    }),
                    t.functional(
                        "supports",
            ...
            s = {
                ...
                getClassOrder(e) {
                    return (function (e, t) {
                        let { astNodes: r, nodeSorting: n } = rt(
                                Array.from(t),
                                e
                            ),
            ...
            let r = 5;
            {
                ...
                n &&
                    ...
                    e.theme.add(
                        ...
                        ut(t.fontFamily.sans, "fontFeatureSettings") ??
                            "normal",
                        r
                    ),
                    e.theme.add(
                        "--default-font-variation-settings",
                        ut(t.fontFamily.sans, "fontVariationSettings") ??
                            "normal",
                        r
                    ));
            }
            {
                ...
                n &&
                    ...
                    e.theme.add(
                        ...
                        ut(t.fontFamily.mono, "fontFeatureSettings") ??
                            "normal",
                        r
                    ),
                    e.theme.add(
                        "--default-mono-font-variation-settings",
                        ut(t.fontFamily.mono, "fontVariationSettings") ??
                            "normal",
                        r
                    ));
            }
